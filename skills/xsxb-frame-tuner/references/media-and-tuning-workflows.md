...
4. Replace-import, then `xsxb_export_gif` plus `xsxb_export_sheet`. GIF forward-play can hide a 7字 — inspect the sheet and split frames. Human inspect sheets pass `grid=false`.
