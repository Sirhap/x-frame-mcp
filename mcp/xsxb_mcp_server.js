...
const INSTRUCTIONS = [
  ...
  "Walk-lock: xsxb_measure_frames → xsxb_register_clip (apply bakes about the feet) → xsxb_export_sheet normalize=feet|none, xsxb_export_overlay or xsxb_diff_frames; plant walk/attack with xsxb_plant_feet reference_animation_id: idle at y=-1, not 0,0. Do not use xsxb_place_image or xsxb_add_attack_trail.",
